...
-- ============================================================================
--
-- The ground truth of bend2-core (core.ts): language, reduction, typing,
...
-- (live) — and no duplication of any kind: Many is unspellable (the
-- parser rejects +, the checker rejects a Many binder at formation) and
-- survives only inside the usage measure, where it means "consumed more
-- than once" and is always a violation. Every live self-call descends
...
-- motive that is dead.
--
-- THE MAP. Part I mirrors src/core.ts section by section, one to one:
--
--   core.ts section   | here          | contents
--   ------------------|---------------|--------------------------------
...
--
-- Char, PMap, Show, Parse, Flatten and the import system are parsing
-- and pipeline concerns with no counterpart here; U32/SCon/SNil string
...
-- .bend files in the repo, checked by core.ts itself.
--
...
--
-- Layout (the core.ts order): §1 Types  §2 Quant  §3 Uses  §4 Term
...
-- other domain passes the ambient demand through (core.ts quant_dem)
...
-- ============================================================================
-- §4 Term (== core.ts Term: apply/unapply, shift, subst, the
...
-- the left-hand-side algebra (core.ts lhs_ext and term_apply)
...
-- ============================================================================
-- §5 Ctx and Book (== core.ts Ctx, Ctrs, Book)
-- ============================================================================
...
-- ============================================================================
-- §6 Compare (== core.ts term_compare and the infer-app
...
-- field of p (core.ts term_compare's LT verdicts)
mutual
...
-- carries the decrease, only spurious mismatch (core.ts infer-app's
...
-- ============================================================================
-- §7 Tele (== core.ts Tele: telescope shapes)
-- ============================================================================
...
-- arity promises of its type (core.ts builds the type from the tele)
...
-- ============================================================================
-- §8 Equal (== core.ts Equal: reduction at two strengths;
-- conversion is joinability of strong runs — no eta, see deltas)
-- ============================================================================
...
-- an unfilled assert) is stuck, and stuck is a value (core.ts wnf
...
-- ============================================================================
-- §9 Check (== core.ts Check: one bidirectional judgment; the
...
-- the goal in core.ts, spelled in the term here)
...
-- REMAINDER of its family (core.ts ctrs_find over book_adt's filtered
...
-- drops its measure from the conclusion, as in core.ts.
...
-- ============================================================================
-- §10 Descent (== core.ts infer-app self-call + lhs threading:
...
-- Both sides pin their field-list arity to the declared C.fn: core.ts
-- constructor nodes are n-ary and always full, and the spine encoding
-- must say so explicitly.
-- ============================================================================
-- §11 Valid (== core.ts Valid: book_valid)
-- ============================================================================
...
-- ============================================================================
-- §12 Claims (core.ts states these in prose; §NZ/§NM prove them)
-- ============================================================================
